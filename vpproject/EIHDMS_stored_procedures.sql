...
WHERE b.report_period_week=in_week AND b.report_period_month=in_month AND b.report_period_quarter=in_quarter AND b.report_period_year=in_calendar_year;
...
SELECT b.data_element_id,b.data_element_value FROM base_data AS b INNER JOIN district AS d ON b.district_id = d.district_id
                ...
                INNER JOIN data_element ON b.data_element_id = data_element.data_element_id 
                INNER JOIN report_form_group AS rg ON data_element.report_form_group_id = rg.report_form_group_id
WHERE b.report_period_month=in_month AND b.report_period_quarter=in_quarter AND b.report_period_year=in_calendar_year;
...
SELECT b.data_element_id,b.data_element_value FROM base_data AS b INNER JOIN district AS d ON b.district_id = d.district_id
                ...
                INNER JOIN data_element ON b.data_element_id = data_element.data_element_id 
                INNER JOIN report_form_group AS rg ON data_element.report_form_group_id = rg.report_form_group_id
WHERE b.report_period_quarter=in_quarter AND b.report_period_year=in_calendar_year;
...
SELECT b.data_element_id,b.data_element_value FROM base_data AS b INNER JOIN district AS d ON b.district_id = d.district_id
                ...
                INNER JOIN data_element ON b.data_element_id = data_element.data_element_id 
                INNER JOIN report_form_group AS rg ON data_element.report_form_group_id = rg.report_form_group_id
WHERE b.report_period_year=in_calendar_year;
