...
public class Receive_SMS extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response) {
        ...
        try (PrintWriter out = response.getWriter()) {
            ...
            String param4 = "msisdn";
            String param4Value = request.getParameter(param4);
            SMSData smsData = new SMSData();
            smsData.load_interface_data_sms(param2Value, param4Value, param3Value);
            out.println("<h1>WBS Acc: " + param1Value + "</h1>");
            out.println("<h1>From: " + param4Value + "</h1>");
