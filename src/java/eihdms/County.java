...
public class County implements Serializable {
	...
	public boolean deleteAndDissociate()throws PersistentException {
		try {
			...
			for(int i = 0; i < lAccess_scopes.length; i++) {
				lAccess_scopes[i].setCounty(null);
			}
			return delete();
		}
		catch(Exception e) {
	...
	@JoinColumns(value={ @JoinColumn(name="district_id", referencedColumnName="district_id", nullable=false) }, foreignKey=@ForeignKey(name="FKcounty100021"))	
	...
	@OneToMany(mappedBy="county", targetEntity=eihdms.Access_scope.class)	
	@org.hibernate.annotations.Cascade({org.hibernate.annotations.CascadeType.SAVE_UPDATE, org.hibernate.annotations.CascadeType.LOCK})	
	@org.hibernate.annotations.LazyCollection(org.hibernate.annotations.LazyCollectionOption.TRUE)	
