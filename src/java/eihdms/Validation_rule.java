...
public class Validation_rule implements Serializable {
	...
	@JoinColumns(value={ @JoinColumn(name="report_form_id", referencedColumnName="report_form_id", nullable=false) }, foreignKey=@ForeignKey(name="FKvalidation252636"))	
	...
	@org.hibernate.annotations.Cascade({org.hibernate.annotations.CascadeType.LOCK})	
	@JoinColumns(value={ @JoinColumn(name="report_form_group_id", referencedColumnName="report_form_group_id", nullable=false) }, foreignKey=@ForeignKey(name="FKvalidation229200"))	
	@org.hibernate.annotations.LazyToOne(value=org.hibernate.annotations.LazyToOneOption.NO_PROXY)	
